...
! function(e, t, i, a) {
    ...
    function n() {
        for (var e = 0, i = ["ms", "moz", "webkit", "o"], a = 0; a < i.length && !t.requestAnimationFrame; ++a) t.requestAnimationFrame = t[i[a] + "RequestAnimationFrame"], t.cancelAnimationFrame = t[i[a] + "CancelAnimationFrame"] || t[i[a] + "CancelRequestAnimationFrame"];
    ...
    function o() {
        return "object" == typeof Modernizr
    }

    function r() {
        if (o() && Modernizr.csstransforms3d) return !0;
        ...
        for (var s in r) n.style[s] !== a && (n.style[s] = "translate3d(1px,1px,1px)", e = t.getComputedStyle(n).getPropertyValue(r[s]));
        return i.body.removeChild(n), e !== a && e.length > 0 && "none" !== e
    }
    ...
    function l(t, i) {
        this.element = t, h = !1, this.options = e.extend({}, p, i), this._defaults = p, this._name = d, this.init(t)
    }
    var m, d = "parallux",
        c = e(t),
        h = !1,
    ...
    t.mobilecheck = function() {
    ...
    }, n(), r() && (u = !0, e("html").addClass("csstransforms3d")), l.prototype = {
        init: function(i) {
            this.options.fullHeight === !1 && e(i).addClass("not-full"), f = t.mobilecheck(), this.updateHeight();
            var a = this,
                n = e(i).find("img.cover, video.cover");
            a.simulateCover(), n.one("load", function() {
                a.simulateCover(), e(this).fadeIn()
            }), n.complete && n.load(), c.bind("orientationchange, resize", function() {
                f || (a.updateHeight(), a.simulateCover(), e(this).trigger("scroll"))
            });
            var o = /^((?!chrome|android).)*safari/i.test(navigator.userAgent),
                r = null != navigator.userAgent.match(/iPad/i);
            if (f || o || e(i).addClass("bg-fixed"), f || r)
                if (e(i).css("overflow", "hidden"), "fixed" === this.options.onMobile) c.scroll(function() {
                    a.updateIndex()
                }), c.scroll();
                else if ("parallax" === this.options.onMobile && u) {
                var l = a.render.bind(a);
                m = setInterval(function() {
                    t.requestAnimationFrame(l)
                }, 10)
            } else e(i).find(".parallux-bg").css("position", "absolute");
            else u ? (c.scroll(function() {
                a.render()
            }), s() ? s() >= 11 ? (e("body").on("mousewheel", function() {
                event.preventDefault();
                var e = event.wheelDelta,
                    i = t.pageYOffset;
                t.scrollTo(0, i - e / 4)
            }), c.scroll()) : (e(t).off("scroll"), this.disableParallax()) : c.scroll()) : this.disableParallax()
        },
        disableParallax: function() {
            e(this.element).removeClass("bg-fixed").addClass("no-parallax")
        },
        ...
        updateIndex: function() {
            var t = e(this.element),
                i = t.offset().top,
                a = c.scrollTop();
            a + c.height() >= i && a <= i + t.height() ? t.css("z-index", 5) : t.css("z-index", 1)
        },
        simulateCover: function() {
            var t = c.height(),
                i = c.width(),
                a = e(this.element).find("img.cover, video.cover");
            a.css({
                width: "auto",
                height: "100%"
            }), a.width() < i && a.css({
            ...
            var n = -(a.width() - i) / 2,
                o = -(a.height() - t) / 2;
            a.css("transform", "translate(" + n + "px," + o + "px)")
        },
        updateHeight: function() {
            var i = e(this.element),
                a = i.find(".parallux-inner"),
                n = 1 + Math.floor(3 * Math.random());
            if (this.options.fullHeight) {
                var r = 0;
                (f || o() && Modernizr.mq("only screen and (max-width: 1024px)") || t.matchMedia && t.matchMedia("only screen and (max-width: 1024px)").matches) && (r = 70), i.height(c.height() + r), i.find(".parallux-bg").height(c.height() + r)
            } else i.find(".parallux-bg").height(i.height());
            h || (a.hasClass("dark") && a.addClass("dark-" + n), a.hasClass("light") && a.addClass("light-" + n), h = !0)
        },
        render: function() {
            var i = e(this.element),
                a = i.find(".parallux-bg"),
                n = a.find(".parallux-inner"),
                o = i.offset().top,
                r = t.scrollY || t.pageYOffset || 0,
                s = c.scrollTop();
            if (s + c.height() >= o && s <= o + i.height()) {
                var l = ((r - o) / 1.3).toFixed(0) + "px";
                a.css("transform", "translate3d(0," + (o - r) + "px,0)"), n.css("transform", "translate3d(0," + l + ",0)")
            } else a.css("transform", "translate3d(0,100%,0)")
        }
    }, e.fn[d] = function(t) {
        return this.each(function() {
            e.data(this, "plugin_" + d) || e.data(this, "plugin_" + d, new l(this, t))
        })
    }
